...
const socials = [
    { icon: <FaGithub />, path: "https://github.com/IT21344824" },
    { icon: <FaLinkedinIn />, path: "https://www.linkedin.com/in/akidu-ekanayake-602763292/" },
    // {icon:<FaYoutube/>,path:""},
...
const Akidu_Social = ({ containerStyles, iconStyles }) => {
