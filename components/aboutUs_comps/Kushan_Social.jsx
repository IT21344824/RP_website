...
const socials = [
    { icon: <FaGithub />, path: "https://github.com/it21273094" },
    { icon: <FaLinkedinIn />, path: "http://www.linkedin.com/in/kushan-virajith" },
    // {icon:<FaYoutube/>,path:""},
...
const Kushan_Social = ({ containerStyles, iconStyles }) => {
